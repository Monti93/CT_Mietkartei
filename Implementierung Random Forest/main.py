...
# Files Paths
TEST_DATA_CSV = os.path.join(os.getcwd(), 'Wohnungskartei', 'Wohnungskartei_Muster_Master_4_S.csv')
TRAIN_DATA_CSV = os.path.join(os.getcwd(), 'Wohnungskartei', 'Wohnungskartei_Muster_Master_6_S_teach.csv')

# Constants 
MAX_RANDOM_TRESS = 1000
DEFAULT_SEPEARTOR = ";"
...
best_accuracy = 0
# for x in range (1, MAX_RANDOM_TRESS):
classifier = RandomForestClassifier(n_estimators=827, random_state=0)
